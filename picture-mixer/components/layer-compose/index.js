    ...
    methods: {
        ...
        async render(layers) {
            ...
            for (let i = 0; i < layers.length; i++) {
                let { src, left = 0, top = 0, width = canvasWidth, height = canvasHeight, angle = 0, type, bgColor, isRender } = layers[i]
            ...
            return { base64, tempPath: await base64ToTempFilePath(base64), width: canvasWidth, height: canvasHeight }
        },
